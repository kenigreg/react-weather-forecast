    ...
    return (
            ...
            <div className="input-group">
                <div className="form-outline main-search" data-mdb-input-init>
                                <input onChange={props.handleChange} id="search-input form1" type="search" className="form-control border border-1" />
                    <label className="form-label" htmlFor="form1">Search for a place</label>
                </div>
                <button onClick={props.handleSubmit} id="search-button" type="button" className="btn btn-primary">
